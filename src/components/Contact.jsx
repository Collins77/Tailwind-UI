                ...
                <div className="mt-6 space-y-8 md:mt-8">
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-white truncate w-72">
                            Popman House, Ground Floor, Opposite the Bazaar
                        </span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-white truncate w-72">(+254) 733208119</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-white truncate w-72">info@modernsolution.com</span>
                    </p>
                </div>
